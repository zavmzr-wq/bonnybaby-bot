...
OPENROUTER_API_KEY = os.getenv("OPENROUTER_API_KEY", "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")
...
async def get_ai_response(user_text: str, history: list) -> str:
    ...
    headers = {
        ...
        "HTTP-Referer": "https://bonnybaby-bot.onrender.com",
        "X-Title": "Bonnybaby Bot",
    }
